...
- 🔥 **Firebase интеграция** - синхронизация с POS-системой в реальном времени
...
1. Скачайте APK из [Releases](https://github.com/yourusername/MyOwnBankTerminal/releases)
2. Установите на Android устройство (минимум Android 8.0)
3. Настройте Firebase Realtime Database
4. Укажите ID терминала в POS-системе
